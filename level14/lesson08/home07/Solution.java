...
public class Solution
{
    ...
    {
        for (Apartament q : apartaments)
        {
            if (q instanceof Apt1Room) ((Apt1Room) q).clean1Room();
            else if (q instanceof Apt2Room) ((Apt2Room) q).clean2Rooms();
            else if (q instanceof Apt3Room) ((Apt3Room) q).clean3Rooms();
        }
    }
